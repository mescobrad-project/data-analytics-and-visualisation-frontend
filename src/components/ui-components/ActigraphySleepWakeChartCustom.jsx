 ...
 */
class ActigraphySleepWakeChartCustom extends React.Component {
    static propTypes = {
    ...
    componentDidMount() {
        ...
        series.dataFields.valueY = "sleep_wake";
        series.name = "Sleep/Wake";
        series.tooltipText = "{sleep_wake}";
...
export default ActigraphySleepWakeChartCustom;
