...
class AlphaDeltaRatioFunctionPage extends React.Component {
    ...
    async handleSubmit(event) {
        ...
        API.get("return_alpha_delta_ratio",
            ...
            this.setState({alpha_delta_ratio: resultJson['alpha_delta_ratio']})
            this.setState({alpha_delta_show: true})
        ...
        return (
                <Grid container direction="row">
                    ...
                    <Grid item xs={8}>
                        ...
                        <div style={{ display: (this.state.alpha_delta_show ? 'block' : 'none') }}>{this.state.alpha_delta_ratio}</div>
                        <hr style={{ display: (this.state.alpha_delta_show ? 'block' : 'none') }}/>
                    </Grid>
                </Grid>
        )
    }
...
export default AlphaDeltaRatioFunctionPage;
