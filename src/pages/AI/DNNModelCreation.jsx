...
class DNNModelCreation extends React.Component {
    constructor(props){
        super(props);
    ...
    async handleSubmit(event) {
        ...
        // Send the request
        API.get("ai_tabular_dnn_training_experiment", {
            params: {
                ...
                <Grid container direction="row">
                    <Grid item xs={4} sx={{ borderRight: "1px solid grey"}}>
                        <Typography variant="h5" sx={{ flexGrow: 1, textAlign: "center" }} noWrap>
                            Deep Neural Network Parameterisation
                        </Typography>
                        <hr/>
...
export default DNNModelCreation;
