...
class XGBoostModelLoad extends React.Component {
    constructor(props){
        super(props);
                ...
                <Grid container direction="row">
                    <Grid item xs={4} sx={{ borderRight: "1px solid grey"}}>
                        <Typography variant="h5" sx={{ flexGrow: 1, textAlign: "center" }} noWrap>
                            XGBoost Regression - Select Model
                        </Typography>
                        <hr/>
                            ...
                            <TabPanel value={this.state.tabvalue} index={0}>
                             ...
                             <TabPanel value={this.state.tabvalue} index={1}>
                                 ...
                                 <Box component={Paper} className="SampleCharacteristics" sx={{width:'90%'}}
                                     ...
                                     <Typography variant="h5" component="div">Estimated coefficients for the XGBoost regression problem.</Typography>
                                     <JsonTable className="jsonResultsTable"
...
export default XGBoostModelLoad;
