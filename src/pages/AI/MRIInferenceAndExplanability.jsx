...
//  TODO
//  dl_explanation_experiment
// Page Name : MRI Inference and Explainability
// Input mri path, model_path change to use local_storage
// Heatmap_path: change to output
...
class MRIInferenceAndExplainability extends React.Component {
    constructor(props){
        super(props);
...
export default MRIInferenceAndExplainability;
