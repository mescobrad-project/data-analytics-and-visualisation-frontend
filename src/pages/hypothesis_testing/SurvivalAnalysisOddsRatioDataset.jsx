...
class SurvivalAnalysisOddsRatioDataset extends React.Component {
    constructor(props){
        super(props);
                            ...
                            <TabPanel value={this.state.tabvalue} index={0}>
                                <div style={{display: (this.state.stats_show ? 'block' : 'none')}}>
                                    <Typography variant="h6" color='royalblue' sx={{ flexGrow: 1, textAlign: "center", padding:'20px'}} >
                                        Estimates of Odds Ratio with a (1-alpha)*100% Confidence interval. </Typography>
...
export default SurvivalAnalysisOddsRatioDataset;
