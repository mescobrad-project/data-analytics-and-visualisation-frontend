                ...
                <Grid item xs={3} sx={{borderRight: "1px solid grey"}}>
                    ...
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <FormControl sx={{m: 1, width: '90%'}} size={"small"}>
                            ...
                            />
                            <FormHelperText>Alpha value to calculate two-sided Wald confidence
                                intervals.</FormHelperText>
                        </FormControl>
                        <FormControl sx={{m: 1, width: '90%'}} size={"small"}>
                            ...
                            <Grid style={{display: (this.state.stats_show ? 'block' : 'none')}}>
                                {this.state.test_data['status'] !== 'Success' ? (
                                    <Typography variant="h6" color='indianred'
                                                sx={{flexGrow: 1, textAlign: "Left", padding: '20px'}}>Status
                                        : {this.state.test_data['status']}</Typography>
                                ) : (
                                    <div style={{display: (this.state.stats_show ? 'block' : 'none')}}>
                                        <Grid container direction="row">
                                            {this.state.Col_transormed.length > 0 ? (
                                                <Grid item xs={2}>
                                                    <Typography variant="h6" color='royalblue' sx={{
                                                        flexGrow: 1,
                                                        textAlign: "center",
                                                        padding: '20px'
                                                    }}>
                                                        ...
                                                        <JsonTable className="jsonResultsTable"
                                                                   rows={this.state.Col_transormed}/>
                                                    </Typography>
                                                </Grid>
                                            ) : ''}
                                            <Grid item xs={10}>
                                                <Typography variant="h6" color='royalblue'
                                                            sx={{flexGrow: 1, textAlign: "center", padding: '20px'}}>
                                                    Estimates of Incidence Rate Difference with a (1-alpha)*100%
                                                    Confidence interval.
                                                    <JsonTable className="jsonResultsTable"
                                                               rows={this.state.RiskTable}/>
                                                </Typography>
                                            </Grid>
                                        </Grid>
                                        <hr className="result"/>
