...
class SurvivalAnalysisNNTDataset extends React.Component {
    constructor(props){
        super(props);
                            ...
                            <TabPanel value={this.state.tabvalue} index={0}>
                                <div style={{display: (this.state.stats_show ? 'block' : 'none')}}>
                                    <Typography variant="h6" color='royalblue' sx={{ flexGrow: 1, textAlign: "center", padding:'20px'}} >
                                        Estimates of Number Needed to Treat. </Typography>
...
export default SurvivalAnalysisNNTDataset;
