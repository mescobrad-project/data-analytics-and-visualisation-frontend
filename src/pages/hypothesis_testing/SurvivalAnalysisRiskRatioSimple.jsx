...
class SurvivalAnalysisRiskRatioSimple extends React.Component {
    constructor(props){
        super(props);
                        ...
                        <Grid style={{display: (this.state.stats_show ? 'block' : 'none')}}>
                            ...
                            <Grid style={{display: (this.state.test_data['status']==='Success' ? 'block' : 'none')}}>
                                <Typography variant="h6" color='royalblue' sx={{ flexGrow: 1, textAlign: "Left", padding:'20px'}} >
                                    Estimated risk ratio = { this.state.test_data['result']['estimated_risk']}</Typography>
                                <Typography variant="h6" color='royalblue' sx={{ flexGrow: 1, textAlign: "Left", padding:'20px'}} >
                                ...
                                <Typography variant="h6" color='royalblue' sx={{ flexGrow: 1, textAlign: "Left", padding:'20px'}} >
                                    Risk ratio standard error = {this.state.test_data.result.standard_error}</Typography>
                            </Grid>
                        </Grid>
                    </Grid>
                </Grid>
...
export default SurvivalAnalysisRiskRatioSimple;
